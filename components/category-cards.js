(function () {
  ...
  window.DelphiPoemsComponents.renderCategoryCards = function renderCategoryCards({ escapeHtml, siteData }) {
    return `
                ...
                (card) => `
                  <div class="col-md-6 col-xl-4">
                    <article class="poem-card text-center h-100">
                      ...
                      <button class="btn btn-dp-primary" data-route="${card.page}">Learn through Poetry</button>
                    </article>
                  </div>
                `,
              )
